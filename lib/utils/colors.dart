...
class AppColors{
  ...
  static final Color mainColor = const Color(0xFF89dad9);
  static final Color secondColor = const Color(0xFFD52E2D);



  //static final Color mainColor = const Color(0xFFfa7552);
  static final Color iconColor1 = const Color(0xFFffd28d);
  static final Color iconColor = const Color(0xFFFFDD00);
